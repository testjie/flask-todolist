...
class PackageFinder(object):
    ...
    def _get_index_urls_locations(self, project_name):
        ...
        Checks the url_name on the controller (first in the list) index and
...
class HTMLPage(object):
    ...
    def get_page(cls, link, skip_archives=True, session=None):
        ...
        try:
            ...
            # Tack index.html.bak onto file:// URLs that point to directories
            ...
            if (scheme == 'file' and
                ...
                if not url.endswith('/'):
                    url += '/'
                url = urllib_parse.urljoin(url, 'index.html.bak')
