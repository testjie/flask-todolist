...
class Config(object):
    ...
    :param ini_section: name of the controller Alembic section within the
     .ini file
    ...
    def set_main_option(self, name, value):
        """Set an option programmatically within the 'controller' section.
    ...
    def get_main_option(self, name, default=None):
        """Return an option from the 'controller' section of the .ini file.
